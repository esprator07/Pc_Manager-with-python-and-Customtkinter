...
class SystemInfoApp:
    ...
    def show_summary(self):
        ...
        for key, value in system_info["system"].items():
            ...
            ctk.CTkLabel(frame, text=f"{key}: {value}", anchor="w").pack(fill="x", padx=10, pady=5)
    ...
    def show_cpu(self):
        ...
        ctk.CTkLabel(right_frame, text=f"Total: {cpu_percent:.1f}%").pack()
    ...
    def show_ram(self):
        ...
        ctk.CTkLabel(top_frame, 
                    text=f"Used: {used_gb:.1f} GB / {total_gb:.1f} GB ({memory.percent:.1f}%)").pack(pady=5)
            ...
            try:
                for os_data in self.c.Win32_OperatingSystem():
                    os_info.update({
                        ...
                        "Install Date": os_data.InstallDate or "Unknown",
                        "Last Boot Time": os_data.LastBootUpTime or "Unknown",
    ...
    def get_architecture_name(self, arch_code):
        architectures = {
            0: "x86",
            1: "MIPS",
            2: "Alpha",
        ...
        return architectures.get(arch_code, f"Unknown ({arch_code})")
